...
final class RegisteredTables
{
    public const USERS = 'admin.users';

    public const TEAMS = 'admin.teams';

    public const MANAGERS = 'admin.teams.structure';

    public const MANAGER_RELATIONSHIP_HISTORY = 'admin.teams.structure.relationship-history';
    ...
    public const TIME_TRACKING_MANAGER_OPERATIONS_DAILY = 'manager.work-time.operations.daily';

    public const TIME_TRACKING_MANAGER_OPERATIONS_OTHER_WORK = 'manager.work-time.operations.other-work';

    public const TIME_TRACKING_MANAGER_OPERATIONS_WORK_SESSIONS = 'manager.work-time.operations.work-sessions';

    public const TIME_TRACKING_MANAGER_OPERATIONS_BREAKS = 'manager.work-time.operations.breaks';

    public const TIME_TRACKING_MANAGER_OPERATIONS_CORRECTIONS = 'manager.work-time.operations.corrections';
    ...
    public static function get(string $key): TableDefinition
    {
        return match ($key) {
            ...
            self::TIME_TRACKING_MANAGER_OPERATIONS_DAILY,
            self::TIME_TRACKING_ADMIN_OPERATIONS_DAILY => new TableDefinition($key, [
            ...
            self::TIME_TRACKING_MANAGER_OPERATIONS_OTHER_WORK,
            self::TIME_TRACKING_ADMIN_OPERATIONS_OTHER_WORK => new TableDefinition($key, [
                new TableColumn('publicId', defaultVisible: false),
                new TableColumn('userPublicId', defaultVisible: false),
                new TableColumn('userName'),
                new TableColumn('userEmail', defaultVisible: false),
            ...
            self::TIME_TRACKING_MANAGER_OPERATIONS_WORK_SESSIONS,
            ...
            self::TIME_TRACKING_MANAGER_OPERATIONS_BREAKS,
            ...
            self::TIME_TRACKING_MANAGER_OPERATIONS_CORRECTIONS,
    ...
    public static function savedViewAccess(string $key): RegisteredTableAccess
    {
        return match ($key) {
            self::USERS => new RegisteredTableAccess('admin.users.index'),
            self::TEAMS => new RegisteredTableAccess('admin.teams.index'),
            self::MANAGERS, self::MANAGER_RELATIONSHIP_HISTORY => new RegisteredTableAccess('admin.teams.structure.show'),
            self::ROLES => new RegisteredTableAccess('admin.authorization.roles.index'),
            self::PACKAGES => new RegisteredTableAccess('admin.authorization.packages.index'),
            self::PERMISSIONS => new RegisteredTableAccess('admin.authorization.permissions.index'),
            self::AUDIT, self::IMPERSONATION_SESSION_EVENTS => new RegisteredTableAccess('admin.audit.index'),
            self::SECURITY_HISTORY => new RegisteredTableAccess('admin.audit.security-history.index'),
            self::RATE_LIMITS => new RegisteredTableAccess('admin.rate-limits.index'),
            self::MODULES, self::MODULE_DETAIL_TEAMS, self::MODULE_DETAIL_HISTORY, self::MODULE_DETAIL_SCHEDULES => new RegisteredTableAccess('admin.modules.index'),
            ...
            self::TIME_TRACKING_USER_WORK_SESSIONS,
            self::TIME_TRACKING_USER_BREAKS,
            self::TIME_TRACKING_USER_CORRECTIONS => new RegisteredTableAccess('users.work-time'),
            self::TIME_TRACKING_MANAGER_OPERATIONS_DAILY => new RegisteredTableAccess('manager.work-time.summary.index'),
            self::TIME_TRACKING_MANAGER_OPERATIONS_OTHER_WORK => new RegisteredTableAccess('manager.work-time.other-work.index'),
            self::TIME_TRACKING_MANAGER_OPERATIONS_WORK_SESSIONS => new RegisteredTableAccess('manager.work-time.work-sessions.index'),
            self::TIME_TRACKING_MANAGER_OPERATIONS_BREAKS => new RegisteredTableAccess('manager.work-time.breaks.index'),
            self::TIME_TRACKING_MANAGER_OPERATIONS_CORRECTIONS => new RegisteredTableAccess('manager.work-time.corrections.index'),
            self::TIME_TRACKING_ADMIN_OPERATIONS_DAILY => new RegisteredTableAccess('admin.work-time.summary.index'),
            self::TIME_TRACKING_ADMIN_OPERATIONS_OTHER_WORK => new RegisteredTableAccess('admin.work-time.other-work.index'),
            self::TIME_TRACKING_ADMIN_OPERATIONS_WORK_SESSIONS => new RegisteredTableAccess('admin.work-time.work-sessions.index'),
            self::TIME_TRACKING_ADMIN_OPERATIONS_BREAKS => new RegisteredTableAccess('admin.work-time.breaks.index'),
            self::TIME_TRACKING_ADMIN_OPERATIONS_CORRECTIONS => new RegisteredTableAccess('admin.work-time.corrections.index'),
            self::FILES => new RegisteredTableAccess('admin.files.index'),
            self::PRIVACY_RETENTION_COVERAGE => new RegisteredTableAccess('admin.privacy-retention.index'),
            self::PRIVACY_LEGAL_HOLDS => new RegisteredTableAccess('admin.privacy-retention.legal-holds.index'),
            self::PRIVACY_OPERATIONS => new RegisteredTableAccess('admin.privacy-retention.operations.index'),
            self::INTEGRATION_ADAPTERS, self::INTEGRATION_RUNS => new RegisteredTableAccess('admin.integrations.index'),
            self::SEARCH_INDEXES, self::SEARCH_REBUILDS => new RegisteredTableAccess('admin.search.index'),
            self::FEATURE_FLAGS, self::FEATURE_FLAG_HISTORY => new RegisteredTableAccess('admin.feature-flags.index'),
            self::MANAGED_PROCESS_RUNS => new RegisteredTableAccess('admin.managed-processes.index'),
            self::MANAGED_PROCESS_DEFINITIONS => new RegisteredTableAccess('admin.managed-processes.definitions.index'),
            self::MANAGED_PROCESS_SCHEDULES => new RegisteredTableAccess('admin.managed-processes.schedules.index'),
            self::IMPORT_ROW_ERRORS => new RegisteredTableAccess('admin.managed-processes.index'),
            default => throw new \InvalidArgumentException(sprintf('Table [%s] is not registered for saved views.', $key)),
        };
    }
    ...
    public static function keys(): array
    {
        return [
            ...
            self::TIME_TRACKING_USER_WORK_SESSIONS,
            self::TIME_TRACKING_USER_BREAKS,
            self::TIME_TRACKING_USER_CORRECTIONS,
            self::TIME_TRACKING_MANAGER_OPERATIONS_DAILY,
            self::TIME_TRACKING_MANAGER_OPERATIONS_OTHER_WORK,
            self::TIME_TRACKING_MANAGER_OPERATIONS_WORK_SESSIONS,
            self::TIME_TRACKING_MANAGER_OPERATIONS_BREAKS,
            self::TIME_TRACKING_MANAGER_OPERATIONS_CORRECTIONS,
            self::TIME_TRACKING_ADMIN_OPERATIONS_DAILY,
            self::TIME_TRACKING_ADMIN_OPERATIONS_OTHER_WORK,
            self::TIME_TRACKING_ADMIN_OPERATIONS_WORK_SESSIONS,
            self::TIME_TRACKING_ADMIN_OPERATIONS_BREAKS,
            self::TIME_TRACKING_ADMIN_OPERATIONS_CORRECTIONS,
            self::FILES,
            self::PRIVACY_RETENTION_COVERAGE,
            self::PRIVACY_LEGAL_HOLDS,
