...
namespace App\Modules\Core\Authorization\Infrastructure\Persistence\TableNames;
...
final class AuthorizationDatabaseTable
{
    ...
    public const USER_TEAM_ASSIGNMENT_PROVENANCE = DatabaseSchema::CORE_AUTHORIZATION.'.user_team_assignment_provenance';
}
