...
final readonly class ReportExportLifecycle implements ReportExportRequestRecorder
{
    ...
    {
        $this->modules->ensureAllowed('reports', $snapshot->activeTeamPublicId, $snapshot->requestingUserPublicId, ReportsPermissionCatalog::REQUEST);
        ...
        if ($snapshot->auditExport) {
            $this->modules->ensureAllowed('reports', $snapshot->activeTeamPublicId, $snapshot->requestingUserPublicId, ReportsPermissionCatalog::AUDIT_EXPORT);
        }
    }
