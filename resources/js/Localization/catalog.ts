...
export const translations = {
    pl: {
        ...
        'navigation.dashboard': 'Dashboard aplikacyjny',
        'pages.dashboard.head_title': 'Dashboard aplikacyjny',
    ...
    en: {
        ...
        'brand.subtitle': 'Debt operations',
        'navigation.admin': 'Admin',
        'navigation.aria.breadcrumb': 'Breadcrumb',
        'navigation.aria.main': 'Main navigation',
        'navigation.aria.mobile': 'Mobile navigation',
        'navigation.dashboard': 'Application dashboard',
        'pages.dashboard.head_title': 'Application dashboard',
        'pages.dashboard.title': 'Application dashboard',
        'user.default_name': 'Atlas User',
        'user.menu': 'User menu',
    },
} as const;
