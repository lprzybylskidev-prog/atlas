    ...
    <AdminLayout :title="t('pages.admin.audit.title')" :title-icon="IconClipboardList">
        <section class="space-y-4">
            <div class="grid gap-3 md:grid-cols-3 xl:grid-cols-6">
                ...
                <FormInput v-model="filters.impersonatedUser" aria-label="Impersonated user public ID" placeholder="Impersonated user" />
                <FormInput
                ...
                <FormInput v-model="filters.action" aria-label="Action" placeholder="Action" />
                <FormInput v-model="filters.team" aria-label="Team public ID" placeholder="Team" />
                <FormInput v-model="filters.module" aria-label="Module" placeholder="Module" />
