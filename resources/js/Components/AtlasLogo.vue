...
<template>
    <div class="flex min-w-0 items-center gap-3">
        ...
        <div
            class="min-w-0 overflow-hidden transition-[max-width,opacity,transform] duration-200 ease-out"
            :class="showText ? 'max-w-44 translate-x-0 opacity-100' : 'max-w-0 -translate-x-1 opacity-0'"
