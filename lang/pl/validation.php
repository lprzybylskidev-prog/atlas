...
return [
    ...
    'calendar_local_time' => 'Wprowadź prawidłową lokalną datę i godzinę w strefie Europe/Warsaw.',
    'calendar_end_after_start' => 'Czas zakończenia musi być późniejszy niż czas rozpoczęcia.',
    'calendar_recurrence_end_after_start' => 'Data końca cyklu nie może być wcześniejsza niż początek wydarzenia.',
    'calendar_stale' => 'To wydarzenie zmieniło się po jego otwarciu. Odśwież kalendarz i sprawdź je ponownie.',
    ...
    'attributes' => [
        'all_day' => 'ustawienie wydarzenia całodniowego',
        'availability' => 'status Wolny/Zajęty',
        'default_reminder_minutes' => 'domyślne przypomnienie',
        'description' => 'opis',
        'email_enabled' => 'ustawienie przypomnień e-mail',
        'ends_at' => 'data i czas zakończenia',
        'location' => 'miejsce',
        'mutation_scope' => 'zakres zmiany',
        'occurrence_date' => 'data wystąpienia',
        'recurrence_count' => 'liczba wystąpień',
        'recurrence_ends_on' => 'data końca cyklu',
        'recurrence_frequency' => 'cykliczność',
        'recurrence_interval' => 'interwał cyklu',
        'recurrence_weekdays' => 'dni tygodnia cyklu',
        'recurrence_weekdays.*' => 'dzień tygodnia cyklu',
        'reminder_minutes' => 'przypomnienia',
        'reminder_minutes.*' => 'przypomnienie',
        'starts_at' => 'data i czas rozpoczęcia',
        'title' => 'tytuł',
        'version' => 'wersja wydarzenia',
